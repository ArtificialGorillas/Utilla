    ...
    public class GamemodeSelector : MonoBehaviour
    {
        ...
        public void GetSelectorGamemodes(out List<Gamemode> baseGamemodes, out List<Gamemode> moddedGamemodes)
        {
            ...
            foreach (Gamemode bm in baseGamemodes)
            {
                ...
                string moddedTitle = isInfection ? "MODDED" : $"MODDED {BaseGamemodeUtils.GetShortName(baseMode).ToUpper()}";
        ...
        void CreatePageButtons(GameObject templateButton)
        {
            ...
            GameObject CreatePageButton(string text, Action onPressed)
            {
                ...
                //button.GetComponent<Renderer>().material = templateButton.GetComponent<GorillaPressableButton>().pressedMaterial;
                ...
                button.transform.localScale = Vector3.one * 0.1427168f;
            ...
            nextPageButton.transform.localPosition = new Vector3(-0.745f, nextPageButton.transform.position.y + 0.005f, nextPageButton.transform.position.z - -0.02f);

            GameObject previousPageButton = CreatePageButton("<--", PreviousPage);
            previousPageButton.transform.localPosition = new Vector3(-0.745f, -0.633f, previousPageButton.transform.position.z - -0.02f);
